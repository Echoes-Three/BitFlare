...
public partial class MainWindow : Window
{
    public MainWindow()
    {
        ...
        viewModel.IntegerClickAnimation  = IntegerToggleAnimation;
        viewModel.Ieee754ClickAnimation  = Ieee754ToggleAnimation;
    }
    ...
    private async void IntegerToggleAnimation() =>
        ClickAnimation(IntegerToggleer);
    
    private async void Ieee754ToggleAnimation() =>
        ClickAnimation(Ieee754Toggleer);
